...
from app.models import DataAnomalyLog, DataQualityCheck, DataValidationRule, Player, StatLine
...
class TestDataQualityService:
    ...
    def test_create_validation_rule(self, db):
        ...
        rule = service.create_validation_rule(
            entity_type="stat_line", field_name="points", rule_type="range", rule_config={"min": 0, "max": 100}
        )
    ...
    def test_validate_entity_range_rule(self, db):
        ...
        service.create_validation_rule(
            entity_type="stat_line", field_name="points", rule_type="range", rule_config={"min": 0, "max": 50}
        )
    ...
    def test_validate_entity_lookup_rule(self, db):
        ...
        service.create_validation_rule(
            entity_type="player", field_name="position", rule_type="lookup", rule_config={"values": ["G", "F", "C"]}
        )
