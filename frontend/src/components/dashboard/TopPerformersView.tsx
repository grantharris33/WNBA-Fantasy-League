        ...
        <div className="flex justify-center items-end space-x-4 mb-8">
          ...
          <div className="text-center">
            ...
            <div className="bg-white p-4 rounded-b-lg shadow-md border-t-0 min-w-[140px]">
              ...
              <div className="text-xs text-gray-600">{topPerformers[1].team_name}</div>
              <div className="text-lg font-bold text-gray-900">{topPerformers[1].points_scored} pts</div>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="bg-white p-4 rounded-b-lg shadow-lg border-t-0 min-w-[160px]">
              ...
              <div className="text-sm text-gray-600">{topPerformers[0].team_name}</div>
              <div className="text-xl font-bold text-gray-900">{topPerformers[0].points_scored} pts</div>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="bg-white p-4 rounded-b-lg shadow-md border-t-0 min-w-[140px]">
              ...
              <div className="text-xs text-gray-600">{topPerformers[2].team_name}</div>
              <div className="text-lg font-bold text-gray-900">{topPerformers[2].points_scored} pts</div>
            </div>
          </div>
        </div>
      )}
          ...
          {topPerformers.map((performer, index) => (
            ...
            >
              ...
              <div className="text-right">
                <div className="text-2xl font-bold text-gray-900">{performer.points_scored}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            ...
            <div className="bg-white rounded-lg p-4">
              ...
              <div className="text-xl font-bold text-gray-900">
                {topPerformers.length > 0
                  ? (topPerformers.slice(0, 5).reduce((sum, p) => sum + p.points_scored, 0) / Math.min(5, topPerformers.length)).toFixed(1)
                  : '0'
                } pts
              </div>
