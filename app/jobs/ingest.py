                ...
                for athlete_block in athletes:
                    ...
                    try:
                        ...
                        try:
                            ...
                            _log_error(provider="rapidapi", msg=f"Validation failed for player {player.id} in game {game_id}: {validation_exc}")
    ...
    try:
        ...
        if minutes == 0 and (points > 0 or rebounds > 0 or assists > 0):
            quality_service._log_anomaly(
                ...
                description=f"Player has positive stats with 0 minutes played",
                severity="high"
            )
